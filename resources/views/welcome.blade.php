                ...
                <div class="row">
                    <div class="col-md-3 col-md-offset-9 col-sm-4 col-sm-offset-8">
                        <div class="search-box map">
                            ...
                            >
                                @csrf
                                <h2>{{ __('apartment.search_properties') }}</h2>
                                <input type="hidden" id="regionsArray" value="{{ json_encode($regions->toArray()) }}">
                                <div class="form-group">
                                    <select name="type" id="roomNumber">
                                        <option value="">{{ __('apartment.type') }}</option>
                                        <option value="1">{{ __('apartment.one_room') }}</option>
                                        <option value="2">{{ __('apartment.two_rooms') }}</option>
                                        <option value="3">{{ __('apartment.three_rooms') }}</option>
                                    </select>
                                </div>
                                <div class="form-group">
